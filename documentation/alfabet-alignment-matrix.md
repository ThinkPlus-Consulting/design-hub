...
| `vision-benchmark.md` | Keep the architecture-view queryability set aligned with the current 71-node benchmarkable taxonomy and the 65 / 97 / 1 / 353 implementation baseline. | P1 |
