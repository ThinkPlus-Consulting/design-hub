...
| `vision-benchmark.md` | Keep the architecture-view queryability set aligned with the current 71-node benchmarkable taxonomy and the 65 / 90 / 1 / 340 implementation baseline. | P1 |
