...
| `vision-benchmark.md` | Keep the architecture-view queryability set aligned with the current 71-node benchmarkable taxonomy and the 65 / 103 / 1 / 363 implementation baseline. | P1 |
