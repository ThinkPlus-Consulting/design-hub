...
import {
  ...
  TenantStatus,
  HealthStatus,
} from './tenant-factsheet-screen-preview.models';
...
export class TenantFactsheetScreenPreviewComponent {
  ...
  readonly breadcrumbHome = { icon: 'pi pi-home', label: 'Home' };
  ...
  kpiGraphCode(index: number): string {
    return `SHL02.SCN03.SEC02.SEC01.ELT${String(7 + index).padStart(2, '0')}`;
  }
}
